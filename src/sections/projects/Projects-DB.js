...
export const projects = [
  {
    ...
    date: 'May 2026',
    text: 'Flow Zone',
    description: "Flow Zone is a full-stack Pomodoro timer application with per-user task tracking, built using the MERN stack (MongoDB, Express.js, React, and Node.js). " +
    ...
    liveLink: 'https://flowzone-dr4.pages.dev/',
    sourceCodeLink: 'https://github.com/vickneee/FlowZone',
  },
  {
    src: MeetingApp,
